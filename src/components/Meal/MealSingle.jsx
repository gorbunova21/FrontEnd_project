  ...
  return (
    <div className='section-wrapper'>
      <div className='container'>
        ...
        <div className='sc-title'>Деталі їжі</div>
        <section className='sc-details bg-white'>
            ...
            <div className='details-intro'>
              ...
              <div className='py-4'>
                <div className='category flex align-center'>
                  <span className='text-uppercase fw-8 ls-1 my-1'>категорія: &nbsp;</span>
                  <span className='text-uppercase ls-2'>{ meal?.category }</span>
                </div>

                <div className='source flex align-center'>
                  <span className='fw-7'>джерело: &nbsp;</span>
                  <a href = {meal.source}>
              ...
              <div className='ingredients my-5 px-3 py-3'>
                <h6 className='fs-16 text-white'>Інгредієнти</h6>
                <ul className='grid'>
                  {
          ...
          <div className='details-body'>
            <div className='measures my-4'>
              <h6 className='fs-16'>Виміряти:</h6>
              <ul className='grid'>
                {
            ...
            <div className='instructions my-4'>
              <h6 className='fs-16'>Інструкція:</h6>
              <ul className='grid'>
                {
